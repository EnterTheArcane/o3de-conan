...
class OpenmeshConan(ConanFile):
    ...
    def package_info(self):
        ...
        # OpenMeshCore
        self.cpp_info.components["openmeshcore"].set_property(
            "cmake_target_name", "OpenMeshCore"
        )
        ...
        # OpenMeshTools
        self.cpp_info.components["openmeshtools"].set_property(
            "cmake_target_name", "OpenMeshTools"
        )
        ...
        self.cpp_info.components["openmeshcore"].names[
            "cmake_find_package"
        ] = "OpenMeshCore"
        self.cpp_info.components["openmeshcore"].names[
        ...
        self.cpp_info.components["openmeshcore"].build_modules[
            "cmake_find_package_multi"
        ] = [self._module_file_rel_path]
        ...
        self.cpp_info.components["openmeshtools"].build_modules[
            "cmake_find_package"
        ] = [self._module_file_rel_path]
        self.cpp_info.components["openmeshtools"].build_modules[
            "cmake_find_package_multi"
