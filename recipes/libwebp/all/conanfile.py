...
class LibwebpConan(ConanFile):
    ...
    def package_info(self):
        ...
        self.cpp_info.components["webpdecoder"].set_property(
            "pkg_config_name", "libwebpdecoder"
        )
        ...
        if Version(self.version) >= "1.3.0":
            # sharpyuv
            self.cpp_info.components["sharpyuv"].set_property(
                "cmake_target_name", "WebP::sharpyuv"
            )
            self.cpp_info.components["sharpyuv"].set_property(
                "pkg_config_name", "libsharpyuv"
            )
        ...
        # webpdemux
        self.cpp_info.components["webpdemux"].set_property(
            "cmake_target_name", "WebP::webpdemux"
        )
        self.cpp_info.components["webpdemux"].set_property(
            "pkg_config_name", "libwebpdemux"
        )
        self.cpp_info.components["webpdemux"].libs = ["webpdemux"]
        self.cpp_info.components["webpdemux"].requires = ["webp"]

        # webpmux
        self.cpp_info.components["webpmux"].set_property(
            "cmake_target_name", "WebP::libwebpmux"
        )
        self.cpp_info.components["webpmux"].set_property(
            "pkg_config_name", "libwebpmux"
        )
