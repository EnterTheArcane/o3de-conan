...
class Recipe(ConanFile):
    ...
    def system_requirements(self):
        ...
        dnf.install_substitutes(
            ["libglvnd-devel"], ["mesa-libGL-devel"], update=True, check=True
        )
        ...
        apt.install_substitutes(
            ["libgl-dev"], ["libgl1-mesa-dev"], update=True, check=True
        )
        ...
        zypper.install_substitutes(
            ["Mesa-libGL-devel", "glproto-devel"],
