...
class Recipe(ConanFile):
    ...
    def requirements(self):
        ...
        if self.settings.os != "Linux":
            ...
            self.requires(
                "libgettext/0.22", transitive_headers=True, transitive_libs=True
            )
    ...
    def generate(self):
        ...
        tc.project_options["libmount"] = (
            "enabled" if self.options.get_safe("with_mount") else "disabled"
        )
        if self.settings.os == "FreeBSD" or self.settings.os == "Neutrino":
            tc.project_options["xattr"] = "false"
        tc.project_options["tests"] = "false"
        tc.project_options["libelf"] = (
            "enabled" if self.options.get_safe("with_elf") else "disabled"
        )
    ...
    def package_info(self):
        ...
        self.cpp_info.components["gmodule-no-export-2.0"].set_property(
            "pkg_config_name", "gmodule-no-export-2.0"
        )
        ...
        self.cpp_info.components["gmodule-export-2.0"].set_property(
            "pkg_config_name", "gmodule-export-2.0"
        )
        self.cpp_info.components["gmodule-export-2.0"].requires += [
            "gmodule-no-export-2.0",
            "glib-2.0",
        ]

        self.cpp_info.components["gmodule-2.0"].set_property(
            "pkg_config_name", "gmodule-2.0"
        )
        self.cpp_info.components["gmodule-2.0"].requires += [
            "gmodule-no-export-2.0",
            "glib-2.0",
        ]

        self.cpp_info.components["gobject-2.0"].set_property(
        ...
        self.cpp_info.components["gobject-2.0"].requires += [
            "glib-2.0",
            "libffi::libffi",
        ]

        self.cpp_info.components["gthread-2.0"].set_property(
            "pkg_config_name", "gthread-2.0"
        )
        ...
        self.cpp_info.components["gio-2.0"].requires += [
            "glib-2.0",
            "gobject-2.0",
            "gmodule-2.0",
            "zlib::zlib",
        ...
        self.cpp_info.components["gresource"].set_property(
            "pkg_config_name", "gresource"
        )
        self.cpp_info.components["gresource"].libs = (
            []
        ...
        if self.settings.os == "Windows":
            self.cpp_info.components["glib-2.0"].system_libs += [
                "ws2_32",
                "ole32",
                "shell32",
                "user32",
            ...
            self.cpp_info.components["gio-2.0"].system_libs.extend(
                ["iphlpapi", "dnsapi", "shlwapi"]
            )
            self.cpp_info.components["gio-windows-2.0"].set_property(
                "pkg_config_name", "gio-windows-2.0"
            )
            ...
            self.cpp_info.components["gio-unix-2.0"].set_property(
                "pkg_config_name", "gio-unix-2.0"
            )
            self.cpp_info.components["gio-unix-2.0"].requires += [
                "gobject-2.0",
                "gio-2.0",
            ]
