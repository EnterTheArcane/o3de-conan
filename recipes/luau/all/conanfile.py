...
class Recipe(ConanFile):
    ...
    def package_info(self):
        ...
        self.cpp_info.components["Common"].set_property(
            "cmake_target_name", "Luau::Common"
        )
        # Ast
        ...
        self.cpp_info.components["Analysis"].set_property(
            "cmake_target_name", "Luau::Analysis"
        )
        self.cpp_info.components["Analysis"].requires = [
            "Ast",
            "Config",
            "Compiler",
            "VM",
        ...
        self.cpp_info.components["Config"].set_property(
            "cmake_target_name", "Luau::Config"
        )
