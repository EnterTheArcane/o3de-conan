...
class PtexConan(ConanFile):
    ...
    def _patch_sources(self):
        ...
        # disable subdirs
        save(
            self, os.path.join(self.source_folder, "src", "utils", "CMakeLists.txt"), ""
        )
        save(
            self, os.path.join(self.source_folder, "src", "tests", "CMakeLists.txt"), ""
        )
    ...
    def package_info(self):
        ...
        self.cpp_info.components["_ptex"].set_property(
            "cmake_target_name", f"Ptex::{cmake_target}"
        )
        self.cpp_info.components["_ptex"].names["cmake_find_package"] = cmake_target
        self.cpp_info.components["_ptex"].names[
