...
class Recipe(ConanFile):
    ...
    def _patch_sources(self):
        ...
        for pattern in [
            ...
            replace_in_file(
                self, os.path.join(self.source_folder, "CMakeLists.txt"), pattern, ""
            )
        ...
        for pattern in ["-Werror", "/WX"]:
            ...
            replace_in_file(
                self,
                os.path.join(self.source_folder, "code", "CMakeLists.txt"),
                pattern,
                "",
            )
        ...
        for contrib_header, include in [
            ...
            save(
                self,
                os.path.join(self.source_folder, "contrib", contrib_header),
                f"#include <{include}>\n",
            )
